...
const description = computed(() =>
  props.locale === 'en'
    ? 'Your trusted partner for banking, insurance and strategic consulting in Bamako.'
...
<template>
  <footer class="border-t border-gray-800 bg-[#0A1929] text-gray-300">
    <div class="container mx-auto px-4 py-12 lg:px-8">
      <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
        <div>
          ...
          <p class="mb-4 text-sm text-gray-400">{{ description }}</p>
          <div class="flex gap-4">
            <a href="#" class="text-gray-400 transition-colors hover:text-[#4CAF50]" aria-label="Facebook">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
              </svg>
            </a>
            <a href="#" class="text-gray-400 transition-colors hover:text-[#4CAF50]" aria-label="Twitter">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        ...
        <div>
          <h3 class="mb-4 font-semibold text-white">{{ quickLinksTitle }}</h3>
          <ul class="space-y-2">
            <li v-for="link in links" :key="link.href">
              <a :href="link.href" class="text-sm text-gray-400 transition-colors hover:text-[#4CAF50]">
                {{ link.label }}
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li class="flex items-center gap-2 text-sm text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0 text-[#4CAF50]" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
            ...
            <li class="flex items-center gap-2 text-sm text-gray-400">
              ...
              <a :href="`tel:${phone}`" class="transition-colors hover:text-[#4CAF50]">{{ phone }}</a>
            </li>
            <li class="flex items-center gap-2 text-sm text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0 text-[#4CAF50]" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
              ...
              <a :href="`mailto:${email}`" class="transition-colors hover:text-[#4CAF50]">{{ email }}</a>
            </li>
          </ul>
        </div>
      </div>
      <div class="mt-8 border-t border-gray-800 pt-8 text-center">
        <p class="text-sm text-gray-400">© {{ year }} Ecofinconseils. {{ allRights }}</p>
      </div>
    </div>
  </footer>
</template>
